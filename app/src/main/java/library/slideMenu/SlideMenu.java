...
import library.slideMenu.utils.ScrollDetectors;
            ...
            switch (layoutParams.role) {
                ...
                case LayoutParams.ROLE_SECONDARY_MENU:
                    measureChildWithMargins(
                            ...
                            widthMeasureSpec,
                            0,
                            slideMode == MODE_SLIDE_WINDOW ? MeasureSpec.makeMeasureSpec(measureHeight - statusBarHeight, MeasureSpec.getMode(heightMeasureSpec)) : heightMeasureSpec, 0);
                    break;
            }
